...
})({"3NaV0":[function(require,module,exports) {
...
const startPokedex = async ()=>{
    await fetch("https://ddragon.leagueoflegends.com/cdn/13.18.1/data/es_ES/champion.json").then(function(result) {
        ...
        for(const key in result.data){
            let champion = new (0, _championJsDefault.default)(result.data[key]);
...
const showPokedex = async ()=>{
    ...
    for(var i = 0; i < champions.length; i++){
        ...
        while(aux != champions[i].pkm_type.length){
            if (aux == 0) var tipo1 = champions[i].pkm_type[aux].type.name;
            if (aux == 1) var tipo2 = champions[i].pkm_type[aux].type.name;
            else tipo2 = "";
            aux++;
        }
...
},{"./Champion.js":"ecRm1","@parcel/transformer-js/src/esmodule-helpers.js":"1PnRH"}],"ecRm1":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"1PnRH"}],"1PnRH":[function(require,module,exports) {
...
},{}]},["3NaV0","ebWYT"], "ebWYT", "parcelRequire3a28")
